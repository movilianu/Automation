...
def test_summary_page_redirect_description_color_size():
    set_driver(driver)
    get_driver()
    go_to(config.url)
    time.sleep(5)
    ...
    # Testing the shopping cart's Description redirect
    # Click on the color of the item and make sure it redirects properly by ensuring the existance of elements not found in the Summary page but on the product's page
